...
import 'package:shop_app_handeling_apis/gubits/shop_states.dart' as shop;
...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<HomeCubit, HomeStates>(listener: (context, state) {
      ...
      return BlocConsumer<ShopCubit, shop.ShopStates>(
                    ...
                    children: [
                      VisibilityDetector(
                        ...
                        onVisibilityChanged: (VisibilityInfo info) {
                          homeCubit
                              .updateAutoPlay(!(info.visibleFraction == 0));
                        },
